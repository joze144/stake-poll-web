    ...
    return (
      <Container component="main" maxWidth="md" className="pt-40">
        ...
        <Typography variant="body1" color="textSecondary">
          ...
          We use the Ethereum network for fraud prevention. Each user has to authenticate with Ethereum wallet before voting.
          Each vote is further staked with the amount of ETH users hold in the wallet. That gives a poll creator a unique
          opportunity to not only get feedback, but see that feedback weighted by the amount of token each voter holds.
        </Typography>
        ...
        <Typography variant="body1" color="textSecondary">
          ...
          After the poll is created it can be shared with others using share buttons. If you want to vote on the polls
          however,you first have to authenticate using an Ethereum wallet.
        </Typography>
        <Typography className={this.props.classes.title} variant="h5" color="textPrimary">
        ...
        <Typography variant="body1" color="textSecondary">
          ...
          into the browser. Then you can create an Ethereum wallet or import existing one into the plugin.
        </Typography>
        <Typography className={this.props.classes.title} variant="h5" color="textPrimary">
